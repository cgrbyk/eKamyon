...
class FirmaBilgisiGuncelle extends StatefulWidget {
  @override
  FirmaBilgisiGuncelleEkrani createState() => FirmaBilgisiGuncelleEkrani();
}
...
class FirmaBilgisiGuncelleEkrani extends State<FirmaBilgisiGuncelle> {
  ...
  void initState() {
    ...
    bankaIbanUc.text=AktifKullaniciBilgileri.firmaBankaUc;
  }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        body: Container(
          ...
          child: ListView(
            children: <Widget>[//                                                               ownFocus     nextFocus
              customTextBox(TextInputType.text, "Firma Adi", firmaAdi, TextInputAction.next, firmaAdiNode, firmaIlNode, false),
              customTextBox(TextInputType.text, "Firma Il", firmaIl, TextInputAction.next, firmaIlNode, firmaIlceNode, false),
              customTextBox(TextInputType.text, "Firma Ilce", firmaIlce, TextInputAction.next, firmaIlceNode, firmaAdresNode, false),
              customTextBox(TextInputType.text, "Firma Adres", firmaAdres, TextInputAction.next, firmaAdresNode, vergiDairesNode, false),
              customTextBox(TextInputType.text, "Vergi Dairesi", vergiDaires, TextInputAction.next, vergiDairesNode, toplamAracSayisiNode, false),
              customTextBox(TextInputType.number, "Toplam Araç Sayısı", toplamAracSayisi, TextInputAction.next, toplamAracSayisiNode,personelSayisiNode, false),
              customTextBox(TextInputType.number, "Personel Sayısı", personelSayisi, TextInputAction.next, personelSayisiNode, sahipOlunanBelgelerNode, false),
              customTextBox(TextInputType.text, "Sahip olunan belgeler", sahipOlunanBelgeler, TextInputAction.next, sahipOlunanBelgelerNode, faaliyetSuresiNode, false),
              customTextBox(TextInputType.phone, "Web Sitesi", webSitesi, TextInputAction.next, webSitesiNode, sabitTelNode, false),
              customTextBox(TextInputType.phone, "Sabit telefon", sabitTel, TextInputAction.next, sabitTelNode, cepTelNode, false),
              customTextBox(TextInputType.text, "Ceb telefonu", cepTel, TextInputAction.next, cepTelNode, bankaAdiBirNode, false),
              customTextBox(TextInputType.text, "1.Banka Adi", bankaAdiBir, TextInputAction.next, bankaAdiBirNode, bankaIbanBirNode, false),
              customTextBox(TextInputType.text, "1.Banka Iban", bankaIbanBir, TextInputAction.next, bankaIbanBirNode, bankaAdiIkiNode, false),
              customTextBox(TextInputType.text, "2.Banka Adi", bankaAdiIki, TextInputAction.next, bankaAdiIkiNode, bankaIbanIkiNode, false),
              customTextBox(TextInputType.text, "2.Banka Iban", bankaIbanIki, TextInputAction.next, bankaIbanIkiNode, bankaAdiUcNode, false),
              customTextBox(TextInputType.text, "3.Banka Adi", bankaAdiUc, TextInputAction.next, bankaAdiUcNode, bankaIbanUcNode, false),
              customTextBox(TextInputType.text, "3.Banka Iban", bankaAdiUc, TextInputAction.done, bankaIbanUcNode, new FocusNode(), false),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: <Widget>[
                  FlatButton(
                    child: Text("Vazgeç",style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold,fontSize: 18),),
                    onPressed: (){
                      Navigator.of(context).pop();
                    },
                  ),
                  FlatButton(
                    child: Text("Değişiklikleri Kaydet",style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold,fontSize: 17)),
                    onPressed: (){
                      //Database Kaydetme işlemi
                      _showDialog("Değişiklier kaydedildi", "Yaptığınız değişiklikler başarıyla kaydedildi");
                      Navigator.of(context).pop();
                    },
                  ),
                ],
